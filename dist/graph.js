 ...
 */
export function buildFleetGraph(nodes, edges) {
 ...
 */
export function quickCheck(graph) {
 ...
 */
export function analyzeFleetGraph(graph, checkCycles = true) {
    const rigidity = checkLamanRigidity(graph.V, graph.E);
    const emergence = detectEmergence(graph.V, graph.E, graph.C);
    let zhc = null;
 ...
 */
export function fromCoordinateGraph(V, E, neighbors, nodeIds) {
