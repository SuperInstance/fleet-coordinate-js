 ...
 */
import { directionToTrust, DIRECTION_COUNT } from './pythagorean48.js';
/**
 ...
 */
export function computeLoopResidual(trustEdges, tolerance = 1e-6) {
 ...
 */
export function computeLoopResidualByDirection(directions, tolerance = 1e-6) {
 ...
 */
export function findCycles(edges, maxCycles = 10) {
